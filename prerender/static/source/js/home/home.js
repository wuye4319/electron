...
var _tmall = __webpack_require__(7);
...
var Content = function (_React$Component) {
  ...
  _createClass(Content, [{
    ...
    value: function componentDidMount() {
      ...
      var webview = document.getElementById('view0');
      ...
      webview.addEventListener('did-finish-load', function () {
        if (webview.getURL().indexOf('detail.tmall.com/item.htm') !== -1) {
          console.log(_tmall.tmall.init);
          var str = _tmall.tmall.init + ';init()';
    ...
    key: 'alertOnlineStatus',
    value: function alertOnlineStatus() {
      console.log(navigator.onLine ? 'online' : 'offline');
    }
  }, {
    key: 'goback',
    value: function goback() {
      var currid = 'view' + this.state.currwin;
      var webview = document.getElementById(currid);
      webview.goBack();
    }
  }, {
    key: 'goforward',
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              'ul',
              null,
              this.state.winbox.map(function (data, index) {
                return React.createElement(
                  'li',
                  { key: index },
                  data.title || index
...
var tmall = {
  init: function init() {
    // $('.tb-action').innerHTML = '<div class="buy"><button>添加到superbuy购物车</button></div>'
    alert(document.getElementsByClassName('tb-action')[0].innerHTML);
  }
};
